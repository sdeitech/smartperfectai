...
', $this );
	...
	private function compose( $send = true ) {
		...
		/* Code to check user id is which country based */
			...
			// }
			// //$real_ip_adress = '198.7.59.119'; // US IP
			// $cip = $real_ip_adress;
    ...
    if($ip_data && $ip_data->geoplugin_countryName != null){
        ...
        //$iptolocation = 'http://api.hostip.info/country.php?ip=' . $cip;
        //$creatorlocation = strtolower($result['country']);
			$creatorlocation = $result['country'];
			if($creatorlocation == "IN" || $creatorlocation == ''){
				return wp_mail( $recipient, $subject, $body, $headers, $attachments );
			}
			else{
				return wp_mail('info@smartdatainc.net', $subject, $body, $headers, $attachments );
			}
		/* Code to check user id is which country based */		
